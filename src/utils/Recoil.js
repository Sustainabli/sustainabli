...
export const userInfoSelector = selector({
  ...
  get: async ({ get }) => {
    ...
    console.log('recoil', amplifyUser);
    if (amplifyEmail) {
    ...
    if (userInfo) {
      switch (userInfo.role) {
        ...
        case ORGANIZATION_ADMIN_ROLE:
          return fetchSensorInfoFromOrganization(userInfo.organization_code);
        case USER_ROLE:
          return fetchSensorInfoFromGroup(userInfo.organization_code, userInfo.group_name);
        default:
      }
    }
  },
