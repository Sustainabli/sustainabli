            ...
            <Container fluid>
              <React.Fragment>
                <Row className='profile-info d-inline-flex flex-row'>
                  ...
                  <Card.Img variant="top" src={michael_li_pfp} style={{ width: '20rem' }}/>
                  <Col className='py-3 px-5'>
                    ...
                    <h2 className='button-cell'>{this.renderShowModalButton(UPDATE_USER_INFO, 'Edit Information', userInfo, null, null, null)}</h2>
                  </Col>
